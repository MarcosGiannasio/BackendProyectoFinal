...
export default class CartManager {
    ...
    addProductToCart = async (cartId, productId) => {
        ...
        try {
            ...
            await cart.save();
            return productInCart ? "Se sumó un producto" : "Producto Agregado";
    ...
    updateCartQuantity = async (cartId, productId, quantity) => {
        ...
        try {
            ...
            console.log(error.message);
            return "Error al modificar la cantidad del productos en el carrito";
        }
    };
    ...
    deleteCartById = async (id) => {
        ...
        try {
            ...
            console.log(error.message);
            return "Hugo un error al eliminar los productos del carrito";
        }
    };
